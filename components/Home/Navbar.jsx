    ...
    return (
        <nav className={style.navbar}>
            ...
            <div data-isdrop={isDropDown} className={style.dropDownMenu}>
                <a className={style.dropDownItems}>
                    Edit Profile
                </a>
                <a className={style.dropDownItems} style={{ transitionDelay: "0.1s", display: 'flex', alignItems: 'center', justifyContent: 'space-between' }} onClick={() => signOutFunction()}>Logout
